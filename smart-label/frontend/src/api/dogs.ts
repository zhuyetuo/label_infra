...
export const createDog = (body: { dog_code: string; name?: string; breed?: string; imu?: string; aliases?: string; remark?: string }) =>
  request.post<never, Dog>("/dogs", body);

export const updateDog = (id: number, body: Partial<Pick<Dog, "name" | "breed" | "imu" | "aliases" | "remark">>) =>
